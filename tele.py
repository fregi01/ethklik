...
░░░░░░░░____▓░
\033[1;32m╔════════════════════════════════════════════════╗
\033[1;32m║Supported         : FA                          ║
\033[1;32m║Special Thanks    : ALL MEMBER X TEAM           ║
\033[1;32m║Video channel     : Fregianda		  ║
\033[1;32m║Telegram group    : Fregianda		║
\033[1;32m║Doge Donate :nanti aja			║
\033[1;32m╚════════════════════════════════════════════════╝
"""+Style.RESET_ALL+Style.BRIGHT+Fore.WHITE+"""[Berterimakasih lah kepada Tuhan]                                               [Author :  Nirvan with all Member from GRATIS OK]
"""

cname = '@ETH_Ads_nl_bot'
crot = 'https://t.me/ETH_Ads_nl_bot'
...
async def main():
	...
	# Free_LTC_Robot
	print_msg_time(Fore.GREEN + f'Name    : @ETH_Ads_nl_bot '  + Fore.RESET)
	...
	while(True):
		...
		print_msg_time(Fore.GREEN + ' Luamyan dapat ETH yaa kan' + choice + Fore.RESET)
		time.sleep(32)
		i = 1
